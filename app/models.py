...
class User(db.Model):
    ...
    day1 = db.Column(db.Boolean, unique=False)
    day2 = db.Column(db.Boolean, unique=False)
    food1 = db.Column(db.Boolean, unique=False)
    food2 = db.Column(db.Boolean, unique=False)
